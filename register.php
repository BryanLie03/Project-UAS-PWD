        ...
        <div class="login-container">
            ...
            <form action="sv_register.php" method="POST">
                ...
                <div class="input-group">
                    ...
                    <input type="text" id="nama" name="full_name" placeholder="Masukkan nama lengkap" required>
                </div>

                <div class="input-group">
                    <label class="label-login" for="phone">Nomor Telepon</label>
                    <input type="text" id="phone" name="phone_number" placeholder="Masukkan nomor telepon" required>
                </div>
